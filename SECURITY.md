...
If you discover a security vulnerability in Icon Manager, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-icon-manager/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- SVG XSS via icon upload or rendering
- File upload vulnerabilities (file type confusion, path traversal)
