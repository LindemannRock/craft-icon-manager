...
class Install extends Migration
{
    ...
    protected function createTables(): void
    {
        ...
        $this->createTable('{{%iconmanager_settings}}', [
            ...
            // PHP SVG Optimizer settings (v8 plugin-supported rules)
            'optimizeAllowRiskyRules' => $this->boolean()->notNull()->defaultValue(true),
            ...
            'optimizeFixAttributeNames' => $this->boolean()->notNull()->defaultValue(true),
            ...
            'optimizeRemoveAriaAndRole' => $this->boolean()->notNull()->defaultValue(false),
            'optimizeRemoveComments' => $this->boolean()->notNull()->defaultValue(true),
            'optimizeRemoveDataAttributes' => $this->boolean()->notNull()->defaultValue(false),
            ...
            'optimizeRemoveDuplicateElements' => $this->boolean()->notNull()->defaultValue(true),
            'optimizeRemoveEmptyGroups' => $this->boolean()->notNull()->defaultValue(true),
            ...
            'optimizeRemoveEmptyTextElements' => $this->boolean()->notNull()->defaultValue(true),
            ...
            'optimizeRemoveNonStandardAttributes' => $this->boolean()->notNull()->defaultValue(false),
            'optimizeRemoveNonStandardTags' => $this->boolean()->notNull()->defaultValue(false),
            'optimizeRemoveTitleAndDesc' => $this->boolean()->notNull()->defaultValue(false),
            'optimizeRemoveUnsafeElements' => $this->boolean()->notNull()->defaultValue(true),
            ...
            'optimizeScopeSvgStyles' => $this->boolean()->notNull()->defaultValue(false),
